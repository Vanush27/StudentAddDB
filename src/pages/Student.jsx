...
class Student extends Component {
    ...
    deleteStudent = async (e, id) => {
        ...
        const res = await axios.delete(`http://laravelapi.loc/api/delete-student/${id}`);
    ...
    getStudentsApi = async () => {
        const res = await axios.get('http://laravelapi.loc/api/students');
        // console.log(res);
        if (res.data.status === 200) {
            this.setState({
                ...
                this.state.students.map((item) => {
                    return (
                        <tr key={item.id}>
                            ...
                            <td>
                                <button onClick={(e) => this.deleteStudent(e, item.id)} type="button"
